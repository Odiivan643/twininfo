    ...
    <div class="col-md-8">
        ...
        <input type="text"  placeholder="Name ..."  name="name" value="{{ old('name', isset($post) ? $post->name : '') }}" class="form-control" id="name" aria-describedby="nameHelp" required/>
        ...
        <input type="text"  placeholder="Date ..."  name="date" value="{{ old('date', isset($post) ? $post->date : '') }}" class="form-control" id="date" aria-describedby="dateHelp" required/>
    ...
    <div class="col-md-4">
    <a  class="btn btn-danger mt-1" href="{{ route('admin.post.index') }}">
    Cancel
</a>
<button class="btn btn-primary mt-1"> {{ isset($post) ? 'Update' : 'Create' }}</button>
    </div>
